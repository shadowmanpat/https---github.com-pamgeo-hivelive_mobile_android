...
public class MyDraggableItemAdapter extends RecyclerView.Adapter<MyDraggableItemAdapter.MyViewHolder>
    ...
    public static class MyViewHolder extends AbstractDraggableItemViewHolder {
        ...
        public MyViewHolder(View v) {
            ...
            imageSort_iv = (SimpleDraweeView)v.findViewById(R.id.image_sort_iv);
            mDragHandle = (View)v.findViewById(R.id.drag_handle);
        }
    }

    public MyDraggableItemAdapter(Context con, ArrayList<Answer> imageUrls) {
        mContext = con;
        data = imageUrls;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View v = inflater.inflate((viewType == 0) ? R.layout.list_item2_draggable : R.layout.list_item2_draggable, parent, false);
...
//        Log.e("AdapterForSorting", "item has image? "+ item.getImageurl());
        holder.imageSort_iv.setImageURI(Uri.parse(item.getImageurl().startsWith("admin") ? "http://images.clipartpanda.com/smiley-face-png-96527038_o.png" : item.getImageurl()));
        ...
        if (((dragState & STATE_FLAG_IS_UPDATED) != 0)) {
            ...
            if ((dragState & STATE_FLAG_IS_ACTIVE) != 0) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    ...
                    Utils.clearState(holder.imageSort_iv.getDrawable());
                }
